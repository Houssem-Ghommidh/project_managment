...
function ListDemandeProdduitTechnicien() {
  ...
  const colors = tokens(theme.palette.mode);
    ...
    async function getData(){
        const res = await axios.get(`${process.env.REACT_APP_BASE_URL}/api/affecterproduit/bytechnicien/${localStorage.getItem('id')}`);
...
export default ListDemandeProdduitTechnicien