...
import { useSidebarContext } from "./sidebarContextSuperviseur";
...
{`${localStorage.getItem('first_name')} ${localStorage.getItem('last_name')}`}                   </Typography>
           ...
           <Box paddingLeft={collapsed ? undefined : "10%"}>
            ...
            />
              ...
              to="/superviseur/listdemandeproduit"
              icon={<FormatListBulletedIcon />}
              selected={selected}
              setSelected={setSelected}
            />
            ...
            /> */}
              ...
              to="/superviseur/listdemandeachat"
              icon={<FormatListBulletedIcon />}
              selected={selected}
              setSelected={setSelected}
            />
            ...
            <Item
              ...
              to="/superviseur/affectersupperviseur"
              icon={<ForwardIcon />}
              selected={selected}
              setSelected={setSelected}
            />
            ...
            />
              ...
              to="/superviseur/affectertechnicien"
              icon={<ForwardIcon />}
              selected={selected}
              setSelected={setSelected}
            />
...
export default MyProSidebarSuperviseur;
