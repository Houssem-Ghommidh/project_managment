...
function CardProjetClient() {
    ...
    function goToTache(e){
       navigate("/client/cardtache", { state: { idProjet: e._id, nomProjet:e.nom_projet,client:e.id_client } } )
    ...
    async function getData(){
        const res = await axios.get(`${process.env.REACT_APP_BASE_URL}/api/projet/byclient/${localStorage.getItem('id')}`);
...
export default CardProjetClient
