...
function CardFormulaireTechnicien() {
  ...
  const handleClose = () => setOpen(false);
    ...
    function addProject(){
      ...
      :isSuperviseur?  navigate(`/superviseur/formformulaire/${idProjet}`, { state: { idProjet: idProjet, nomProjet:nomProjet,idTache:idTache } }):navigate(`/technicien/formformulaire/${idProjet}`, { state: { idProjet: idProjet, nomProjet:nomProjet,idTache:idTache } });
...
: navigate(`/superviseur/formformulaire/${idProjet}`, { state: { idProjet: idProjet, nomProjet:nomProjet,idTache:idTache } });
 ...
 :isSuperviseur? navigate(`/superviseur/generatepdf`, { state: {client:client,tache:e.id_tache ?e.id_tache.nom_tache:"pas de tache",intervention:e.Intervention,failures_and_Observations:e.Failures_and_Observations, last_PM_Hours:e.Last_PM_Hours,running_Hours:e.Running_Hours, status:e.Status, engine :e.Engine,date:e.Date, technicien:`${e.Technician_on_duty.first_name} ${e.Technician_on_duty.last_name}`,locationField:e.Location }}):navigate(`/technicien/generatepdf`, { state: {client:client,tache:e.id_tache ?e.id_tache.nom_tache:"pas de tache",intervention:e.Intervention,failures_and_Observations:e.Failures_and_Observations, last_PM_Hours:e.Last_PM_Hours,running_Hours:e.Running_Hours, status:e.Status, engine :e.Engine,date:e.Date, technicien:`${e.Technician_on_duty.first_name} ${e.Technician_on_duty.last_name}`,locationField:e.Location }});
  
  }


    async function getData(){
        const res = await axios.get(`${process.env.REACT_APP_BASE_URL}/api/rapport/bytechnicien/${localStorage.getItem('id')}`);
...
export default CardFormulaireTechnicien
